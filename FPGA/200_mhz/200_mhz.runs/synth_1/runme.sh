...
HD_PWD='/home/patch/200_mhz/200_mhz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_200.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_200.tcl
